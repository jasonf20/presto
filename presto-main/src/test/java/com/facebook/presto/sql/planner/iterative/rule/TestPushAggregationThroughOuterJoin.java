        ...
        extends BaseRuleTest
{
                ...
                .on(p -> p.aggregation(ab -> ab
                        .source(
                                p.join(
                                        ...
                                        ImmutableList.of(new ConnectorJoinNode.EquiJoinClause(p.variable("COL1"), p.variable("COL2"))),
                ...
                .matches(
                        project(ImmutableMap.of(
                                ...
                                join(ConnectorJoinNode.Type.INNER, ImmutableList.of(),
                                        join(ConnectorJoinNode.Type.LEFT, ImmutableList.of(equiJoinClause("COL1", "COL2")),
        ...
        tester().assertThat(new PushAggregationThroughOuterJoin(getFunctionManager()))
                .on(p -> p.aggregation(ab -> ab
                        .source(p.join(
                                ...
                                p.values(p.variable("COL2")),
                                p.values(ImmutableList.of(p.variable("COL1")), ImmutableList.of(constantExpressions(BIGINT, 10L))),
                                ImmutableList.of(new ConnectorJoinNode.EquiJoinClause(p.variable("COL2"), p.variable("COL1"))),
                ...
                .matches(
                        project(ImmutableMap.of(
                                ...
                                "COL1", expression("COL1")),
                                join(ConnectorJoinNode.Type.INNER, ImmutableList.of(),
                                        join(ConnectorJoinNode.Type.RIGHT, ImmutableList.of(equiJoinClause("COL2", "COL1")),
                                                aggregation(
                                                        singleGroupingSet("COL2"),
                                                        ImmutableMap.of(Optional.of("AVG"), functionCall("avg", ImmutableList.of("COL2"))),
                                                        ImmutableMap.of(),
    ...
    public void testDoesNotFireWhenGroupingOnInner()
    {
        tester().assertThat(new PushAggregationThroughOuterJoin(getFunctionManager()))
                .on(p -> p.aggregation(ab -> ab
                        .source(p.join(ConnectorJoinNode.Type.LEFT,
                                p.values(ImmutableList.of(p.variable("COL1")), ImmutableList.of(constantExpressions(BIGINT, 10L))),
