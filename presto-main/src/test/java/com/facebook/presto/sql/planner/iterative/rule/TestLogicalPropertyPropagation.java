    ...
    public void testJoinNodeLogicalProperties()
    {
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER,
                            ...
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER,
                            ...
                            p.rowExpression("o_shippriority = 10"),
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.LEFT, p.limit(7, ordersTableScan), customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.LEFT, ordersTableScan, p.limit(8, customerTableScan),
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.RIGHT, customerTableScan, p.limit(9, ordersTableScan),
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.RIGHT, p.limit(10, customerTableScan), ordersTableScan,
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.LEFT, customerTableScan, ordersTableScan,
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, customerTableScan, ordersTableScan, emptyList(), ImmutableList.of(customerCustKeyVariable, ordersOrderKeyVariable, ordersCustKeyVariable), Optional.empty());
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, p.limit(11, customerTableScan), p.limit(12, ordersTableScan), emptyList(), ImmutableList.of(customerCustKeyVariable, ordersOrderKeyVariable, ordersCustKeyVariable), Optional.empty());
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, customerTableScan, ordersTableScan, emptyList(),
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, values1, values2, emptyList(), ImmutableList.of(c1, c2), Optional.empty());
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.FULL, values1, values2, emptyList(), ImmutableList.of(c3, c4), Optional.empty());
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.FULL, customerTableScan, ordersTableScan, emptyList(), ImmutableList.of(customerCustKeyVariable, ordersOrderKeyVariable), Optional.empty());
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.FULL, p.limit(12, customerTableScan), p.limit(10, ordersTableScan),
                            ImmutableList.of(new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable)),
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, p.limit(2, customerTableScan), ordersTableScan, emptyList(),
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, ordersTableScan, p.limit(2, customerTableScan), emptyList(),
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, values, customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(finalC1, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, customerTableScan, values,
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, finalC));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.FULL, customerTableScan, values,
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, finalC2));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.FULL, values, customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(finalC3, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    JoinNode customerOrderJoin = p.join(CanonicalJoinNode.Type.INNER,
                            customerTableScan,
                            p.limit(6, ordersTableScan),
                            new CanonicalJoinNode.EquiJoinClause(customerCustKeyVariable, ordersCustKeyVariable));
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER,
                            customerOrderJoin,
                            lineitemTableScan,
                            new CanonicalJoinNode.EquiJoinClause(ordersOrderKeyVariable, lineitemOrderkeyVariable));
                })
                .matches(expectedLogicalProperties);
    }
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.aggregation(builder -> builder
                            ...
                            .source(p.join(CanonicalJoinNode.Type.INNER,
                                    customerOrderJoin,
                                    lineitemTableScan,
                                    new CanonicalJoinNode.EquiJoinClause(ordersOrderKeyVariable, lineitemOrderkeyVariable))));
                })
    ...
    public void testLimitNodeLogicalProperties()
    {
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    JoinNode ordersCustomerJoin = p.join(CanonicalJoinNode.Type.INNER, ordersTableScan, customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, p.limit(5, ordersTableScan), customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
    ...
    public void testTopNNodeLogicalProperties()
    {
        ...
        tester().assertThat(new NoOpRule(), logicalPropertiesProvider)
                .on(p -> {
                    ...
                    return p.join(CanonicalJoinNode.Type.INNER, p.topN(5, ImmutableList.of(ordersCustKeyVariable), ordersTableScan), customerTableScan,
                            new CanonicalJoinNode.EquiJoinClause(ordersCustKeyVariable, customerCustKeyVariable));
                })
                .matches(expectedLogicalProperties);
