...
public class PropertyDerivations
{
    ...
    static boolean spillPossible(Session session, ConnectorJoinNode.Type joinType)
    {
    ...
    public static Optional<VariableReferenceExpression> filterOrRewrite(Collection<VariableReferenceExpression> columns, List<ConnectorJoinNode.EquiJoinClause> equalities, VariableReferenceExpression column)
    {
        ...
        for (ConnectorJoinNode.EquiJoinClause equality : equalities) {
