        ...
        implements Rule<JoinNode>
{
    ...
    private Collection<VariableReferenceExpression> extractNotNullVariables(List<ConnectorJoinNode.EquiJoinClause> joinCriteria, Optional<RowExpression> joinFilter,
            List<VariableReferenceExpression> candidates, JoinNotNullInferenceStrategy notNullInferenceStrategy)
    {
        ...
        for (ConnectorJoinNode.EquiJoinClause criteria : joinCriteria) {
