        ...
        implements Rule<FilterNode>
{
    ...
    public Result apply(FilterNode filterNode, Captures captures, Context context)
    {
        ...
        JoinNode newJoinNode = new JoinNode(joinNode.getSourceLocation(),
                ...
                ImmutableList.of(new ConnectorJoinNode.EquiJoinClause(leftJoinInput.getJoinKey(), rightJoinInput.getJoinKey()),
                        new ConnectorJoinNode.EquiJoinClause(leftJoinInput.getUnnestIndex(), rightJoinInput.getUnnestIndex())),
                joinOutput.build(),
                joinNode.getFilter(),
                Optional.empty(),
                Optional.empty(),
