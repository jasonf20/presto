...
public class TestPickJoinSides
{
    ...
    {
        return Arrays.stream(CanonicalJoinNode.Type.values())
                .collect(toDataProvider());
    }

    @Test(dataProvider = "joinTypes")
    public void testFlipsWhenProbeSmaller(CanonicalJoinNode.Type joinType)
    {
        int aSize = 100;
        int bSize = 10_000;
        assertPickJoinSides()
                ...
                .on(p ->
                        p.join(
                                ...
                                ImmutableList.of(new CanonicalJoinNode.EquiJoinClause(p.variable("A1", BIGINT), p.variable("B1", BIGINT))),
    ...
    @Test(dataProvider = "joinTypes")
    public void testDoesNotFireWhenTablesSameSize(CanonicalJoinNode.Type joinType)
    {
        int aSize = 100;
        int bSize = 100;
        assertPickJoinSides()
    ...
    @Test(dataProvider = "joinTypes")
    public void testFlipWhenOneTableMuchSmallerAndJoinCardinalityUnknown(CanonicalJoinNode.Type joinType)
    {
        int aRows = 100;
        int bRows = 10_000;
        assertPickJoinSides()
        ...
        assertPickJoinSides()
                ...
                .on(p -> {
                    ...
                    return p.join(
                            ...
                            ImmutableList.of(new CanonicalJoinNode.EquiJoinClause(b1, a1)),
        ...
        assertPickJoinSides()
                ...
                .on(p -> {
                    ...
                    return p.join(
                            ...
                            ImmutableList.of(new CanonicalJoinNode.EquiJoinClause(a1, b1)),
